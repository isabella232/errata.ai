var URL = "https://github.com/errata-ai/errata.ai/releases/download/v1.0.0";

var win = URL + "/Vale-Server-1.11.0-windows.exe";
var mac = URL + "/Vale-Server-1.11.0-macos.dmg";
var linux = URL + "/Vale-Server-1.11.0-linux.AppImage";
