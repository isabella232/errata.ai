  ...
  if (platform.startsWith('Win')) {
    ...
    $('#platform-other')
        .html(
            ...
            'Also available for <a href="' + mac +
            '"><i class="fab fa-apple" aria-hidden="true"></i> macOS</a> and ' +
            '<a href="' + linux +
            '"><i class="fab fa-linux" aria-hidden="true"></i> Linux</a>.' +
            '</span>')
  }
    ...
    $('#platform-other')
        .html(
            '<span class="text-muted">' +
            'Also available for <a href="' + win +
            '"><i class="fab fa-windows" aria-hidden="true"></i> Windows</a> and ' +
            '<a href="' + linux +
            '"><i class="fab fa-linux" aria-hidden="true"></i> Linux</a>.' +
            '</span>')
  }
    ...
    $('#platform-other')
        .html(
            ...
            '"><i class="fab fa-windows" aria-hidden="true"></i> Windows</a> and ' +
            '<a href="' + mac +
            '" <i class="fab fa-apple" aria-hidden="true"></i> macOS</a>.' +
            '</span>')
  }
})
